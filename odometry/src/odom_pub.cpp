...
const double TICKS_PER_REVOLUTION = 180; // For reference purposes.
...
void update_odom() {
  ...
  double cycleDistance = (distanceRight/3 + distanceLeft/3) / 2;
   
  // Calculate the number of radians the robot has turned since the last cycle
  double cycleAngle = -asin((distanceRight/3-distanceLeft/3)/WHEEL_BASE);
